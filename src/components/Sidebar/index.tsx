...
function Sidebar() {
  ...
  const openChatManagement = useUIStore((s) => s.openChatManagement);
          ...
          <div className="flex-1 overflow-y-auto">
            <div className="px-1.5 py-2">
              <div className="flex items-center justify-between mb-2 px-3">
                <h3 className="text-xs font-semibold text-neutral-500 dark:text-white uppercase tracking-wider transition-colors duration-200">
                  Chats
                </h3>
                <button
